...
if(ENABLE_TEST_DEPENDENCIES)
  list(APPEND LIBLOGGING_CONFIGURE_CMD LDFLAGS=-Wl,-rpath,${STAGE_EMBEDDED_DIR}/lib:${INSTALL_PREFIX_EMBEDDED}/lib)
else()
  list(APPEND LIBLOGGING_CONFIGURE_CMD LDFLAGS=-Wl,-rpath,${INSTALL_PREFIX_EMBEDDED}/lib)
endif()
...
if(ENABLE_TEST_DEPENDENCIES)
  list(APPEND RSYSLOG_CONFIGURE_CMD LDFLAGS=-Wl,-rpath,${STAGE_EMBEDDED_DIR}/lib:${INSTALL_PREFIX_EMBEDDED}/lib)
endif()
