...
Developer::Application.config.secret_token = ENV["RAILS_SECRET_TOKEN"] || development_secret_token
if(!%w(development test).include?(Rails.env))
  if(Developer::Application.config.secret_token == development_secret_token)
