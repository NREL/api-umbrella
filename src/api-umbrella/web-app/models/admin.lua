...
Admin = model_ext.new_class("admins", {
  ...
  as_json = function(self, options)
    local data = {
      ...
      reset_password_sent_at = time.postgres_to_iso8601(self.reset_password_sent_at) or json_null,
      sign_in_count = self.sign_in_count or json_null,
      current_sign_in_at = time.postgres_to_iso8601(self.current_sign_in_at) or json_null,
      last_sign_in_at = time.postgres_to_iso8601(self.last_sign_in_at) or json_null,
      ...
      locked_at = time.postgres_to_iso8601(self.locked_at) or json_null,
