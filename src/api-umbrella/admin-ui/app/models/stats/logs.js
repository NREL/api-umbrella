...
class Logs extends EmberObject.extend(Evented) {
  ...
  static fieldTooltips = {
    ...
    request_ip_country: t('The 2 letter country code (<a href="https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" target="_blank">ISO 3166-1</a>) that the IP address geocoded to.\n*Example:* `US`'),
    request_ip_region: t('The up to 3 character state or region code (<a href="https://en.wikipedia.org/wiki/ISO_3166-2" target="_blank">ISO 3166-2</a>) that the IP address geocoded to.\n*Example:* `CO`'),
    ...
    response_custom2: t('The value of the `X-Api-Umbrella-Analytics-Custom2` header sent on the response. This can be used by an API backend to send custom analytics information that will be collected and logged.\n*Example:* `hello-world`'),
    response_custom3: t('The value of the `X-Api-Umbrella-Analytics-Custom3` header sent on the response. This can be used by an API backend to send custom analytics information that will be collected and logged.\n*Example:* `hello-world`'),
