  ...
  didInsertElement() {
    ...
    let $queryBuilder = $('#query_builder').queryBuilder({
      ...
      filters: [
        {
          id: 'request_method',
          label: i18n.t('Request: HTTP Method'),
          description: i18n.t('The HTTP method of the request.\n*Example:* `GET`, `POST`, `PUT`, `DELETE`, etc.'),
          type: 'string',
        ...
        {
          id: 'request_scheme',
          label: i18n.t('Request: URL Scheme'),
          description: i18n.t('The scheme of the original request URL.\n*Example:* `http` or `https`'),
          type: 'string',
          operators: selectOperators,
          input: 'select',
          values: {
        ...
        {
          id: 'request_host',
          label: i18n.t('Request: URL Host'),
          description: i18n.t('The host of the original request URL.\n*Example:* `example.com`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'request_path',
          label: i18n.t('Request: URL Path'),
          description: i18n.t('The path portion of the original request URL.\n*Example:* `/geocode/v1.json`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'request_url',
          label: i18n.t('Request: Full URL & Query String'),
          description: i18n.t('The original, complete request URL.\n*Example:* `http://example.com/geocode/v1.json?address=1617+Cole+Blvd+Golden+CO`\n*Note:* If you want to simply filter on the host or path portion of the URL, your queries will run better if you use the separate "Request: URL Path" or "Request: URL Host" fields.'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'request_ip',
          label: i18n.t('Request: IP Address'),
          description: i18n.t('The IP address of the requestor.\n*Example:* `93.184.216.119`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'request_ip_country',
          label: i18n.t('Request: IP Country'),
          description: i18n.t('The 2 letter country code (<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" target="_blank">ISO 3166-1</a>) that the IP address geocoded to.\n*Example:* `US`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'request_ip_region',
          label: i18n.t('Request: IP State/Region'),
          description: i18n.t('The 2 letter state or region code (<a href="http://en.wikipedia.org/wiki/ISO_3166-2" target="_blank">ISO 3166-2</a>) that the IP address geocoded to.\n*Example:* `CO`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'request_ip_city',
          label: i18n.t('Request: IP City'),
          description: i18n.t('The name of the city that the IP address geocoded to.\n*Example:* `Golden`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'request_user_agent',
          label: i18n.t('Request: User Agent'),
          description: i18n.t('The full user agent string of the requestor.\n*Example:* `curl/7.33.0`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'request_user_agent_family',
          label: i18n.t('Request: User Agent Family'),
          description: i18n.t('The overall family of the user agent.\n*Example:* `Chrome`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'request_user_agent_type',
          label: i18n.t('Request: User Agent Type'),
          description: i18n.t('The type of user agent.\n*Example:* `Browser`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'request_referer',
          label: i18n.t('Request: Referer'),
          description: i18n.t('The `Referer` header sent on the request\n*Example:* `https://example.com/foo`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'request_origin',
          label: i18n.t('Request: Origin'),
          description: i18n.t('The `Origin` header sent on the request\n*Example:* `https://example.com`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'api_key',
          label: i18n.t('User: API Key'),
          description: i18n.t('The API key used to make the request.\n*Example:* `vfcHB9tOyFKc6YbbdDsE8plxtFHvp9zXIJWAtaep`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          ...
          description: i18n.t('The e-mail address associated with the API key used to make the request.\n*Example:* `john.doe@example.com`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          ...
          description: i18n.t('The user ID associated with the API key used to make the request.\n*Example:* `ad2d94b6-e0f8-4e26-b1a6-1bc6b12f3d76`'),
          type: 'string',
          operators: stringOperators,
        },
        {
          id: 'response_status',
          label: i18n.t('Response: HTTP Status Code'),
          description: i18n.t('The HTTP status code returned for the response.\n*Example:* `200`, `403`, `429`, etc.'),
          type: 'integer',
          operators: numberOperators,
        },
        {
          id: 'gatekeeper_denied_code',
          label: i18n.t('Response: API Umbrella Denied Code'),
          description: i18n.t('If API Umbrella is responsible for blocking the request, this code value describes the reason for the block.\n*Example:* `api_key_missing`, `over_rate_limit`, etc.'),
          type: 'string',
          operators: selectOperators,
          input: 'select',
          values: {
        ...
        {
          id: 'response_time',
          label: i18n.t('Response: Load Time'),
          description: i18n.t('The total amount of time taken to respond to the request (in milliseconds)'),
          type: 'integer',
          operators: numberOperators,
        },
        {
          id: 'response_content_type',
          label: i18n.t('Response: Content Type'),
          description: i18n.t('The content type of the response.\n*Example:* `application/json; charset=utf-8`'),
          type: 'string',
          operators: stringOperators,
        },
      ],
