...
local ApiBackendSettings = model_ext.new_class("api_backend_settings", {
  ...
  as_json = function(self)
    local data = {
      ...
      api_key_verification_transition_start_at = iso8601.format_postgres(self.api_key_verification_transition_start_at) or json_null,
      ...
      require_https_transition_start_at = iso8601.format_postgres(self.require_https_transition_start_at) or json_null,
