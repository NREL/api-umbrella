...
require("api-umbrella.lapis.actions.admin.stats")(app)
require("api-umbrella.lapis.actions.admin.unlocks")(app)
require("api-umbrella.lapis.actions.v0.analytics")(app)
...
require("api-umbrella.lapis.actions.v1.analytics")(app)
