...
_.extend(Worker.prototype, {
  ...
  writeNginxConfig: function(writeConfigsCallback) {
    async.waterfall([
      this.fetchAllApis.bind(this),
      this.writeNginxFrontendConfig.bind(this),
      this.writeNginxApiBackendsConfig.bind(this),
      this.reloadNginxOnChange.bind(this),
    ], writeConfigsCallback);
  },

  fetchAllApis: function(writeNginxConfigCallback) {
    ...
    writeNginxConfigCallback(null, { apis: apis });
  },
  ...
  writeNginxApiBackendsConfig: function(nginxConfig, writeNginxConfigCallback) {
