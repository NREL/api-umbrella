...
module.exports = function(callback) {
  ...
  glob(path.join(templateRoot, '**/*'), function(error, templatePaths) {
    async.each(templatePaths, function(templatePath, eachCallback) {
      ...
      // For the backends template, we don't have the necessary API backend
      ...
      // things are started.
      if(_.contains(installPath, 'nginx/backends.conf') || _.contains(installPath, 'nginx/frontend_hosts.conf')) {
