  ...
  push: function(uid, source, data, processAt) {
    ...
    if(!id) {
      ...
      if(process.env.NODE_ENV !== 'test') {
        console.error('Missing unique request ID for logging. This should not occur. Make sure the "X-Api-Umbrella-Request-ID" HTTP header is present. Generated temporary ID: ' + id);
      }
    }
