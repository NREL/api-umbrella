...
module.exports.defaults = function(log, callback) {
  // Set default null values for all known fields, even if we have no data to
  // make certain types of queries and facets work.
  //
  // Most things in elasticsearch don't seem to require this, but statistical
  // facets on the response_time field fail if there are no records in an
  // entire index with this set (which will be the case for legacy months prior
  // to when we collected reponse times).
  _.defaults(log, {
    api_key: null,
    backend_response_time: null,
    internal_gatekeeper_time: null,
    internal_response_time: null,
    proxy_overhead: null,
    request_accept: null,
    request_accept_encoding: null,
    request_at: null,
    ...
    request_host: null,
    request_ip: null,
    request_ip_country: null,
    request_ip_location: null,
    request_method: null,
    request_origin: null,
    request_path: null,
    request_path_hierarchy: null,
    request_query: null,
    ...
    request_user_agent_family: null,
    request_user_agent_type: null,
    response_age: null,
    ...
    response_time: null,
    response_transfer_encoding: null,
    user_email: null,
    user_id: null,
    user_registration_source: null,
  });
...
module.exports.all = function(elasticSearch, log, callback) {
  async.series([
    module.exports.defaults.bind(this, log),
