...
class Test::Apis::V1::WebsiteBackends::TestCsrf < Minitest::Test
  ...
  def index_url
    "https://127.0.0.1:9081/api-umbrella/v1/website_backends"
  end

  def show_url
    record = FactoryBot.create(:website_backend)
    "https://127.0.0.1:9081/api-umbrella/v1/website_backends/#{record.id}"
  end
end
