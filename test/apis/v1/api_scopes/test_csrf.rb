...
class Test::Apis::V1::ApiScopes::TestCsrf < Minitest::Test
  ...
  def index_url
    "https://127.0.0.1:9081/api-umbrella/v1/api_scopes"
  end

  def show_url
    record = FactoryBot.create(:api_scope)
    "https://127.0.0.1:9081/api-umbrella/v1/api_scopes/#{record.id}"
  end
end
