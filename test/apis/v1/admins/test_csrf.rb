...
class Test::Apis::V1::Admins::TestCsrf < Minitest::Test
  ...
  def index_url
    "https://127.0.0.1:9081/api-umbrella/v1/admins"
  end

  def show_url
    record = FactoryBot.create(:admin)
    "https://127.0.0.1:9081/api-umbrella/v1/admins/#{record.id}"
  end
end
