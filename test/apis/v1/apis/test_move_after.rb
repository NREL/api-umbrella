...
class Test::Apis::V1::Apis::TestMoveAfter < Minitest::Test
  ...
  def test_move_to_beginning_gap_10000
    api1 = FactoryBot.create(:api_backend, :sort_order => 99)
    api2 = create_with_default_sort_order
  ...
  def test_no_movement_updates_sort_order_if_not_evenly_distributed
    api1 = FactoryBot.create(:api_backend, :sort_order => 0)
    api2 = FactoryBot.create(:api_backend, :sort_order => 10_000)
    api3 = FactoryBot.create(:api_backend, :sort_order => 100_000)
  ...
  def test_no_movement_updates_sort_order_if_no_subsequent_record
    api1 = FactoryBot.create(:api_backend, :sort_order => 0)
    api2 = FactoryBot.create(:api_backend, :sort_order => 3_000)
  ...
  def test_no_gaps_reshuffles_positive_orders
    api1 = FactoryBot.create(:api_backend, :sort_order => 0)
    api2 = FactoryBot.create(:api_backend, :sort_order => 1)
    api3 = FactoryBot.create(:api_backend, :sort_order => 2)
    api4 = FactoryBot.create(:api_backend, :sort_order => 3)
    api5 = FactoryBot.create(:api_backend, :sort_order => 10)
  ...
  def test_no_gaps_reshuffles_positive_orders_near_integer_limit
    api1 = FactoryBot.create(:api_backend, :sort_order => 2_147_483_640)
    api2 = FactoryBot.create(:api_backend, :sort_order => 2_147_483_645)
    api3 = FactoryBot.create(:api_backend, :sort_order => 2_147_483_646)
    api4 = FactoryBot.create(:api_backend, :sort_order => 2_147_483_647)
  ...
  def test_no_gaps_reshuffles_negative_orders
    api1 = FactoryBot.create(:api_backend, :sort_order => -10)
    api2 = FactoryBot.create(:api_backend, :sort_order => -9)
    api3 = FactoryBot.create(:api_backend, :sort_order => -8)
    api4 = FactoryBot.create(:api_backend, :sort_order => -7)
    api5 = FactoryBot.create(:api_backend, :sort_order => 0)
  ...
  def test_no_gaps_reshuffles_negative_orders_near_integer_limit
    api1 = FactoryBot.create(:api_backend, :sort_order => -2_147_483_648)
    api2 = FactoryBot.create(:api_backend, :sort_order => -2_147_483_647)
    api3 = FactoryBot.create(:api_backend, :sort_order => -2_147_483_646)
    api4 = FactoryBot.create(:api_backend, :sort_order => -2_147_483_640)
