...
class TestAdminUiApis < Minitest::Capybara::Test
  ...
  def test_form
    ...
    assert_selector("#" + field["data-ace-content-id"], :text => "foo,bar bar,foo")
    assert_equal("foo,bar\nbar,foo", find_by_id(field["data-raw-input-id"], :visible => :all).value)
    field = find_field("API Key Missing", :visible => :all)
    assert_selector("#" + field["data-ace-content-id"], :text => "foo1: bar1 bar1: foo1")
    ...
    assert_selector("#" + field["data-ace-content-id"], :text => "foo2: bar2 bar2: foo2")
    ...
    assert_selector("#" + field["data-ace-content-id"], :text => "foo3: bar3 bar3: foo3")
    ...
    assert_selector("#" + field["data-ace-content-id"], :text => "foo4: bar4 bar4: foo4")
    ...
    assert_selector("#" + field["data-ace-content-id"], :text => "foo5: bar5 bar5: foo5")
