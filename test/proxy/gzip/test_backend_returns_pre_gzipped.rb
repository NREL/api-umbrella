...
class Test::Proxy::Gzip::TestBackendReturnsPreGzipped < Minitest::Test
  ...
  def test_underlying_api_is_pre_gzipped
    response = Typhoeus.get("http://127.0.0.1:9444/compressible-pre-gzip", http_options.deep_merge(:accept_encoding => "gzip"))
    ...
    response = Typhoeus.get("http://127.0.0.1:9444/compressible-pre-gzip", http_options)
    assert_response_code(200, response)
