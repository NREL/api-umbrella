...
class TestProxyFormattedErrorsDataVariables < Minitest::Test
  ...
  def test_variables
    response = Typhoeus.get("http://127.0.0.1:9080/#{unique_test_class_id}/hello", self.http_options.except(:headers))
  ...
  def test_escapes_html_values
    response = Typhoeus.get("http://127.0.0.1:9080/#{unique_test_class_id}/hello.html", self.http_options.except(:headers))
  ...
  def test_escapes_csv_values
    response = Typhoeus.get("http://127.0.0.1:9080/#{unique_test_class_id}/hello.csv", self.http_options.except(:headers))
