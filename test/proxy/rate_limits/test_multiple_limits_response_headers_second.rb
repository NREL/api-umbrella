...
class TestProxyRateLimitsMultipleLimitsResponseHeadersSecond < Minitest::Test
  ...
  def test_returns_limit_header_even_when_first_limit_is_exceeded
    responses = make_requests("/api/hello", 15, :api_key => FactoryGirl.create(:api_user).api_key)
