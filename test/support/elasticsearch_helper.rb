class ElasticsearchHelper
  def self.clean_es_indices(indices)
    indices.each do |month|
      ...
      # index.
      client.indices.refresh(:index => "api-umbrella-logs-#{month}")
      ...
      while(result = client.scroll(:scroll_id => result["_scroll_id"], :scroll => "10m")) # rubocop:disable Lint/AssignmentInCondition
